...
(* OASIS_START *)
(* DO NOT EDIT (digest: c9fc7c6392a20c7f351cc7d2f9a96a85) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["derui"];
          homepage = None;
          synopsis = "Linux key configuration tool by OCaml";
          description = None;
          categories = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some ".\156\167 \223\022\171\156\156\166\146w\228\191D\236";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
